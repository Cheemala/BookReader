...
fun SplashScreen(navController: NavController) {
    ...
    LaunchedEffect(key1 = true) {
        ...
        delay(2000L)
        navController.popBackStack(BookReaderScreens.SplashScreen.name, true)
        navController.navigate(BookReaderScreens.SignUpOrLoginScreen.name)
    }
    ...
    Column(modifier = Modifier
        ...
        Surface(
            ...
            AppHeaderText(title = stringResource(id = R.string.app_name))
        }
    }
